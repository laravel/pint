...
As mentioned above, Pint is built on top of the [PHP-CS-Fixer](https://github.com/FriendsOfPHP/PHP-CS-Fixer) tool, as such, you may use any of its rules to fix coding-style issues in your code: [https://github.com/FriendsOfPHP/PHP-CS-Fixer/blob/master/doc/rules/index.rst](github.com/FriendsOfPHP/PHP-CS-Fixer/blob/master/doc/rules)
