...
class ConfiguratorCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'pint:configurator';
     ...
     * @var string
     */
    protected $description = 'Configure pint configuration';

    private array $presets = ['laravel', 'per', 'psr12', 'symfony', 'empty'];
    ...
    public function handle(): void
    {
        ...
        $this->info("Generated pint.json file!");
    }
